...
var x__885__auto__ = (((store == null))?null:store);
var m__886__auto__ = (dogfort.middleware.session.store.read_session[goog.typeOf(x__885__auto__)]);
if(!((m__886__auto__ == null))){
return m__886__auto__.call(null,store,key);
} else {
var m__886__auto____$1 = (dogfort.middleware.session.store.read_session["_"]);
if(!((m__886__auto____$1 == null))){
return m__886__auto____$1.call(null,store,key);
} else {
...
var x__885__auto__ = (((store == null))?null:store);
var m__886__auto__ = (dogfort.middleware.session.store.write_session[goog.typeOf(x__885__auto__)]);
if(!((m__886__auto__ == null))){
return m__886__auto__.call(null,store,key,data);
} else {
var m__886__auto____$1 = (dogfort.middleware.session.store.write_session["_"]);
if(!((m__886__auto____$1 == null))){
return m__886__auto____$1.call(null,store,key,data);
} else {
...
var x__885__auto__ = (((store == null))?null:store);
var m__886__auto__ = (dogfort.middleware.session.store.delete_session[goog.typeOf(x__885__auto__)]);
if(!((m__886__auto__ == null))){
return m__886__auto__.call(null,store,key);
} else {
var m__886__auto____$1 = (dogfort.middleware.session.store.delete_session["_"]);
if(!((m__886__auto____$1 == null))){
return m__886__auto____$1.call(null,store,key);
} else {
