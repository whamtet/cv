...
return cljs.core.vec.call(null,cljs.core.mapcat.call(null,(function (p1__4524_SHARP_){
return cljs.core.remove.call(null,(function (x){
return (cljs.core.seq_QMARK_.call(null,x)) || (cljs.core.not.call(null,x));
}),cljs.core.tree_seq.call(null,cljs.core.seq_QMARK_,cljs.core.identity,p1__4524_SHARP_));
}),v));
});
...
return f.call(null,cljs.core.mapv.call(null,(function (p1__4525_SHARP_){
return cljs_pdfkit$optimize_dom$postwalk.call(null,f,p1__4525_SHARP_);
}),m));
} else {
return m;
}
...
return f.call(null,cljs.core.mapv.call(null,(function (p1__4526_SHARP_){
return cljs_pdfkit$optimize_dom$complete_postwalk.call(null,f,p1__4526_SHARP_);
...
if(cljs.core.vector_QMARK_.call(null,m)){
if(cljs.core.truth_(cljs.core.some.call(null,cljs_pdfkit.optimize_dom.element_tag_QMARK_,m))){
return cljs.core.mapv.call(null,(function (p1__4527_SHARP_){
return cljs_pdfkit$optimize_dom$prewalk.call(null,f,p1__4527_SHARP_);
}),f.call(null,m));
} else {
return m;
}
 ...
 */
cljs_pdfkit.optimize_dom.add_style = (function cljs_pdfkit$optimize_dom$add_style(p__4528){
var vec__4530 = p__4528;
var tag = cljs.core.nth.call(null,vec__4530,(0),null);
var style = cljs.core.nth.call(null,vec__4530,(1),null);
var children = cljs.core.nthnext.call(null,vec__4530,(2));
var v = vec__4530;
 ...
 */
cljs_pdfkit.optimize_dom.refactor_tag = (function cljs_pdfkit$optimize_dom$refactor_tag(p__4531){
var vec__4533 = p__4531;
var tag = cljs.core.nth.call(null,vec__4533,(0),null);
var style = cljs.core.nth.call(null,vec__4533,(1),null);
var children = cljs.core.nthnext.call(null,vec__4533,(2));
var v = vec__4533;
...
cljs_pdfkit.optimize_dom.percolate_up = (function cljs_pdfkit$optimize_dom$percolate_up(p__4535){
var vec__4537 = p__4535;
var tag = cljs.core.nth.call(null,vec__4537,(0),null);
var style = cljs.core.nth.call(null,vec__4537,(1),null);
var children = cljs.core.nthnext.call(null,vec__4537,(2));
var v = vec__4537;
...
return cljs.core.vec.call(null,cljs.core.list_STAR_.call(null,tag,cljs.core.merge.call(null,style,common_map),cljs.core.map.call(null,((function (common_map,vec__4537,tag,style,children,v){
return (function (p1__4534_SHARP_){
return cljs.core.update_in.call(null,p1__4534_SHARP_,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(1)], null),cljs_pdfkit.optimize_dom.map_difference,common_map);
});})(common_map,vec__4537,tag,style,children,v))
,children)));
}
});
cljs_pdfkit.optimize_dom.percolate_down = (function cljs_pdfkit$optimize_dom$percolate_down(p__4539){
var vec__4541 = p__4539;
var tag = cljs.core.nth.call(null,vec__4541,(0),null);
var style = cljs.core.nth.call(null,vec__4541,(1),null);
var children = cljs.core.nthnext.call(null,vec__4541,(2));
var v = vec__4541;
...
return cljs.core.vec.call(null,cljs.core.list_STAR_.call(null,tag,cljs_pdfkit.optimize_dom.map_difference.call(null,style,godown),cljs.core.map.call(null,((function (godown,vec__4541,tag,style,children,v){
return (function (p1__4538_SHARP_){
return cljs.core.update_in.call(null,p1__4538_SHARP_,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(1)], null),((function (godown,vec__4541,tag,style,children,v){
return (function (child_opts){
return cljs.core.merge.call(null,godown,child_opts);
});})(godown,vec__4541,tag,style,children,v))
);
});})(godown,vec__4541,tag,style,children,v))
,children)));
}
