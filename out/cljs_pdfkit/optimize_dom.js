...
return cljs.core.vec.call(null,cljs.core.mapcat.call(null,(function (p1__4541_SHARP_){
return cljs.core.remove.call(null,(function (x){
return (cljs.core.seq_QMARK_.call(null,x)) || (cljs.core.not.call(null,x));
}),cljs.core.tree_seq.call(null,cljs.core.seq_QMARK_,cljs.core.identity,p1__4541_SHARP_));
}),v));
});
...
return f.call(null,cljs.core.mapv.call(null,(function (p1__4542_SHARP_){
return cljs_pdfkit$optimize_dom$postwalk.call(null,f,p1__4542_SHARP_);
}),m));
} else {
return m;
}
...
return f.call(null,cljs.core.mapv.call(null,(function (p1__4543_SHARP_){
return cljs_pdfkit$optimize_dom$complete_postwalk.call(null,f,p1__4543_SHARP_);
...
if(cljs.core.vector_QMARK_.call(null,m)){
if(cljs.core.truth_(cljs.core.some.call(null,cljs_pdfkit.optimize_dom.element_tag_QMARK_,m))){
return cljs.core.mapv.call(null,(function (p1__4544_SHARP_){
return cljs_pdfkit$optimize_dom$prewalk.call(null,f,p1__4544_SHARP_);
}),f.call(null,m));
} else {
return m;
}
 ...
 */
cljs_pdfkit.optimize_dom.add_style = (function cljs_pdfkit$optimize_dom$add_style(p__4545){
var vec__4547 = p__4545;
var tag = cljs.core.nth.call(null,vec__4547,(0),null);
var style = cljs.core.nth.call(null,vec__4547,(1),null);
var children = cljs.core.nthnext.call(null,vec__4547,(2));
var v = vec__4547;
 ...
 */
cljs_pdfkit.optimize_dom.refactor_tag = (function cljs_pdfkit$optimize_dom$refactor_tag(p__4548){
var vec__4550 = p__4548;
var tag = cljs.core.nth.call(null,vec__4550,(0),null);
var style = cljs.core.nth.call(null,vec__4550,(1),null);
var children = cljs.core.nthnext.call(null,vec__4550,(2));
var v = vec__4550;
...
cljs_pdfkit.optimize_dom.percolate_up = (function cljs_pdfkit$optimize_dom$percolate_up(p__4552){
var vec__4554 = p__4552;
var tag = cljs.core.nth.call(null,vec__4554,(0),null);
var style = cljs.core.nth.call(null,vec__4554,(1),null);
var children = cljs.core.nthnext.call(null,vec__4554,(2));
var v = vec__4554;
...
return cljs.core.vec.call(null,cljs.core.list_STAR_.call(null,tag,cljs.core.merge.call(null,style,common_map),cljs.core.map.call(null,((function (common_map,vec__4554,tag,style,children,v){
return (function (p1__4551_SHARP_){
return cljs.core.update_in.call(null,p1__4551_SHARP_,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(1)], null),cljs_pdfkit.optimize_dom.map_difference,common_map);
});})(common_map,vec__4554,tag,style,children,v))
,children)));
}
});
cljs_pdfkit.optimize_dom.percolate_down = (function cljs_pdfkit$optimize_dom$percolate_down(p__4556){
var vec__4558 = p__4556;
var tag = cljs.core.nth.call(null,vec__4558,(0),null);
var style = cljs.core.nth.call(null,vec__4558,(1),null);
var children = cljs.core.nthnext.call(null,vec__4558,(2));
var v = vec__4558;
...
return cljs.core.vec.call(null,cljs.core.list_STAR_.call(null,tag,cljs_pdfkit.optimize_dom.map_difference.call(null,style,godown),cljs.core.map.call(null,((function (godown,vec__4558,tag,style,children,v){
return (function (p1__4555_SHARP_){
return cljs.core.update_in.call(null,p1__4555_SHARP_,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(1)], null),((function (godown,vec__4558,tag,style,children,v){
return (function (child_opts){
return cljs.core.merge.call(null,godown,child_opts);
});})(godown,vec__4558,tag,style,children,v))
);
});})(godown,vec__4558,tag,style,children,v))
,children)));
}
