...
var vec__4533 = cljs.core.name.call(null,kw).split("-");
var a = cljs.core.nth.call(null,vec__4533,(0),null);
var b = cljs.core.nthnext.call(null,vec__4533,(1));
...
return cljs_pdfkit.util.key_map.call(null,(function (p1__4534_SHARP_){
return cljs_pdfkit.util.capitalize.call(null,cljs.core.name.call(null,p1__4534_SHARP_));
}),m);
});
/**
 * cumulation of seq
...
return cljs.core.reduce.call(null,(function (p__4537,new$){
var vec__4538 = p__4537;
var sum = cljs.core.nth.call(null,vec__4538,(0),null);
var done = cljs.core.nth.call(null,vec__4538,(1),null);
