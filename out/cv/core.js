...
cv.core.handler = dogfort.middleware.routes.routes.call(null,(function (request__6854__auto__){
return dogfort.middleware.routes.eval_route.call(null,request__6854__auto__,null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["test"], null),(function (request__6854__auto____$1){
return cljs.core.pr_str.call(null,cljs.core.deref.call(null,cv.job.jobs));
}));
}),(function (request__6854__auto__){
return dogfort.middleware.routes.eval_route.call(null,request__6854__auto__,null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["jobs"], null),(function (request__6854__auto____$1){
var sb__1204__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR_8216_8219 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR_8217_8220 = cljs.core._STAR_print_fn_STAR_;
cljs.core._STAR_print_newline_STAR_ = true;

cljs.core._STAR_print_fn_STAR_ = ((function (_STAR_print_newline_STAR_8216_8219,_STAR_print_fn_STAR_8217_8220,sb__1204__auto__){
return (function (x__1205__auto__){
return sb__1204__auto__.append(x__1205__auto__);
});})(_STAR_print_newline_STAR_8216_8219,_STAR_print_fn_STAR_8217_8220,sb__1204__auto__))
;
...
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_8217_8220;

cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR_8216_8219;
}
return [cljs.core.str(sb__1204__auto__)].join('');
}));
}),(function (request__6854__auto__){
return dogfort.middleware.routes.eval_route.call(null,request__6854__auto__,new cljs.core.Keyword(null,"post","post",269697687),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["update-jobs"], null),(function (request__6854__auto____$1){
var edn = cljs.core.get_in.call(null,request__6854__auto____$1,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"params","params",710516235),new cljs.core.Keyword(null,"edn","edn",1317840885)], null),cljs.core.get_in.call(null,request__6854__auto____$1,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"params","params",710516235),"edn"], null)));
cv.job.set_jobs_BANG_.call(null,unescape(edn));

return "ok";
}));
}),(function (request__6854__auto__){
return dogfort.middleware.routes.eval_route.call(null,request__6854__auto__,null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [""], null),(function (request__6854__auto____$1){
var req = request__6854__auto____$1;
return cv.core.redirect.call(null,"/index.html");
}));
}),(function (request__6854__auto__){
return dogfort.middleware.routes.eval_route.call(null,request__6854__auto__,null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["get-pdf"], null),(function (request__6854__auto____$1){
var edn = cljs.core.get_in.call(null,request__6854__auto____$1,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"params","params",710516235),new cljs.core.Keyword(null,"edn","edn",1317840885)], null),cljs.core.get_in.call(null,request__6854__auto____$1,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"params","params",710516235),"edn"], null)));
...
return dogfort.middleware.routes.eval_route.call(null,request__6854__auto__,new cljs.core.Keyword(null,"get","get",1683182755),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["get-pdf2"], null),(function (request__6854__auto____$1){
var sym = cljs.core.get_in.call(null,request__6854__auto____$1,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"params","params",710516235),new cljs.core.Keyword(null,"sym","sym",-1444860305)], null),cljs.core.get_in.call(null,request__6854__auto____$1,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"params","params",710516235),"sym"], null)));
...
var len__1288__auto___8222 = arguments.length;
var i__1289__auto___8223 = (0);
while(true){
if((i__1289__auto___8223 < len__1288__auto___8222)){
args__1295__auto__.push((arguments[i__1289__auto___8223]));

var G__8224 = (i__1289__auto___8223 + (1));
i__1289__auto___8223 = G__8224;
continue;
} else {
}
break;
...
cv.core.main.cljs$lang$applyTo = (function (seq8221){
return cv.core.main.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq8221));
});
