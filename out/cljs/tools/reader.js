...
var G__2205 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__2205;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__2207 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__2207,ch);
...
if(("\\" === ch__$1)){
var ch_2208__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_2208__$2 == null)){
cljs.tools.reader.reader_types.reader_error.call(null,rdr,"EOF while reading regex");
} else {
}

sb.append(ch_2208__$2);
} else {
}

var G__2209 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__2209;
continue;
}
}
...
var args2210 = [];
var len__1288__auto___2213 = arguments.length;
var i__1289__auto___2214 = (0);
while(true){
if((i__1289__auto___2214 < len__1288__auto___2213)){
args2210.push((arguments[i__1289__auto___2214]));

var G__2215 = (i__1289__auto___2214 + (1));
i__1289__auto___2214 = G__2215;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args2210.length)].join('')));
...
if(cljs.core.truth_((function (){var or__230__auto__ = cljs.tools.reader.impl.utils.whitespace_QMARK_.call(null,ch);
if(or__230__auto__){
return or__230__auto__;
} else {
var or__230__auto____$1 = cljs.tools.reader.macros.call(null,ch);
...
var vec__2222 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__2222,(0),null);
var start_column = cljs.core.nth.call(null,vec__2222,(1),null);
...
var G__2223 = cljs.core.conj_BANG_.call(null,a,form);
a = G__2223;
continue;
}
}
...
var _STAR_read_delim_STAR_2225 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_2225;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__2228 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__2228,(0),null);
var start_column = cljs.core.nth.call(null,vec__2228,(1),null);
var the_list = cljs.tools.reader.read_delimited.call(null,")",rdr,opts,pending_forms);
var vec__2229 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__2229,(0),null);
var end_column = cljs.core.nth.call(null,vec__2229,(1),null);
...
var vec__2232 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__2232,(0),null);
var start_column = cljs.core.nth.call(null,vec__2232,(1),null);
var the_vector = cljs.tools.reader.read_delimited.call(null,"]",rdr,opts,pending_forms);
var vec__2233 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__2233,(0),null);
var end_column = cljs.core.nth.call(null,vec__2233,(1),null);
...
var vec__2236 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__2236,(0),null);
var start_column = cljs.core.nth.call(null,vec__2236,(1),null);
...
var vec__2237 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__2237,(0),null);
var end_column = cljs.core.nth.call(null,vec__2237,(1),null);
...
var sb = (function (){var G__2240 = (new goog.string.StringBuffer());
G__2240.append(initch);
...
var or__230__auto__ = cljs.tools.reader.impl.commons.match_number.call(null,s);
...
var G__2242 = (function (){var G__2241 = sb;
G__2241.append(ch);

return G__2241;
})();
var G__2243 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__2242;
ch = G__2243;
continue;
}
...
switch (G__2250) {
case "\\":
var G__2254 = (function (){var G__2251 = sb;
G__2251.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__2251;
})();
var G__2255 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__2254;
ch = G__2255;
continue;
...
break;
default:
var G__2256 = (function (){var G__2252 = sb;
G__2252.append(ch);

return G__2252;
})();
var G__2257 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__2256;
ch = G__2257;
continue;
...
var vec__2259 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__2259,(0),null);
var end_column = cljs.core.nth.call(null,vec__2259,(1),null);
...
var vec__2262 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__2262,(0),null);
var column = cljs.core.nth.call(null,vec__2262,(1),null);
...
var or__230__auto__ = cljs.core.get.call(null,cljs.tools.reader._STAR_alias_map_STAR_,sym);
if(cljs.core.truth_(or__230__auto__)){
return or__230__auto__;
} else {
...
var vec__2271 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__2271,(0),null);
var column = cljs.core.nth.call(null,vec__2271,(1),null);
...
var m__$1 = (cljs.core.truth_((function (){var and__218__auto__ = line;
...
var vec__2274 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__2274,(0),null);
var column = cljs.core.nth.call(null,vec__2274,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.reader_types.reader_error.call(null,rdr,"Metadata must be Symbol, Keyword, String or Map");
...
var vec__2279 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__2279,(0),null);
var start_column = cljs.core.nth.call(null,vec__2279,(1),null);
...
var G__2282 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__2282,true,null,opts,pending_forms);
...
var _STAR_suppress_read_STAR_2284 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_2284;
}});
...
var G__2286 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__2286,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__2286,rdr,first_line);

return G__2286;
} else {
var or__230__auto__ = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
if(cljs.core.truth_(or__230__auto__)){
return or__230__auto__;
} else {
...
var G__2291 = matched;
var G__2292 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__2291;
finished = G__2292;
continue;
} else {
...
if(cljs.core.not.call(null,(function (){var and__218__auto__ = opts;
if(cljs.core.truth_(and__218__auto__)){
...
var _STAR_suppress_read_STAR_2294 = cljs.tools.reader._STAR_suppress_read_STAR_;
cljs.tools.reader._STAR_suppress_read_STAR_ = (function (){var or__230__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__230__auto__)){
return or__230__auto__;
} else {
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_2294;
}}
} else {
return cljs.tools.reader.reader_types.reader_error.call(null,rdr,"EOF while reading character");
}
...
var arg_env2297 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__2298 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__2298,"(");
...
var G__2299 = (i + (1));
var G__2300 = cljs.core.conj_BANG_.call(null,args,(function (){var or__230__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__230__auto__)){
return or__230__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env2297;
}});
/**
...
var ch = temp__4423__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__2302 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__2302);
...
var G__2303 = cljs.core.next.call(null,s__$1);
var G__2304 = ret;
s__$1 = G__2303;
r = G__2304;
continue;
...
var G__2305 = cljs.core.next.call(null,s);
var G__2306 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__2305;
key_vals = G__2306;
continue;
} else {
...
var or__230__auto__ = cljs.core.get.call(null,cljs.tools.reader.gensym_env,sym);
if(cljs.core.truth_(or__230__auto__)){
return or__230__auto__;
} else {
...
if((function (){var and__218__auto__ = ((!((form == null)))?((((form.cljs$lang$protocol_mask$partition0$ & (262144))) || (form.cljs$core$IWithMeta$))?true:false):false);
if(and__218__auto__){
...
))))):(cljs.core.truth_((function (){var or__230__auto__ = (form instanceof cljs.core.Keyword);
if(or__230__auto__){
return or__230__auto__;
} else {
var or__230__auto____$1 = typeof form === 'number';
if(or__230__auto____$1){
return or__230__auto____$1;
} else {
var or__230__auto____$2 = typeof form === 'string';
if(or__230__auto____$2){
return or__230__auto____$2;
} else {
var or__230__auto____$3 = (form == null);
if(or__230__auto____$3){
return or__230__auto____$3;
} else {
var or__230__auto____$4 = cljs.tools.reader.bool_QMARK_.call(null,form);
if(cljs.core.truth_(or__230__auto____$4)){
return or__230__auto____$4;
} else {
...
var gensym_env2314 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env2314;
}});
...
var temp__4423__auto__ = (function (){var or__230__auto__ = cljs.tools.reader._STAR_data_readers_STAR_.call(null,tag);
if(cljs.core.truth_(or__230__auto__)){
return or__230__auto__;
} else {
...
var args2321 = [];
var len__1288__auto___2325 = arguments.length;
var i__1289__auto___2326 = (0);
while(true){
if((i__1289__auto___2326 < len__1288__auto___2325)){
args2321.push((arguments[i__1289__auto___2326]));

var G__2327 = (i__1289__auto___2326 + (1));
i__1289__auto___2326 = G__2327;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args2321.length)].join('')));
...
}catch (e2324){if((e2324 instanceof Error)){
var e = e2324;
...
var args2329 = [];
var len__1288__auto___2335 = arguments.length;
var i__1289__auto___2336 = (0);
while(true){
if((i__1289__auto___2336 < len__1288__auto___2335)){
args2329.push((arguments[i__1289__auto___2336]));

var G__2337 = (i__1289__auto___2336 + (1));
i__1289__auto___2336 = G__2337;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args2329.length)].join('')));
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__2332,reader){
var map__2333 = p__2332;
var map__2333__$1 = ((((!((map__2333 == null)))?((((map__2333.cljs$lang$protocol_mask$partition0$ & (64))) || (map__2333.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__2333):map__2333);
var opts = map__2333__$1;
var eof = cljs.core.get.call(null,map__2333__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var args2339 = [];
var len__1288__auto___2342 = arguments.length;
var i__1289__auto___2343 = (0);
while(true){
if((i__1289__auto___2343 < len__1288__auto___2342)){
args2339.push((arguments[i__1289__auto___2343]));

var G__2344 = (i__1289__auto___2343 + (1));
i__1289__auto___2343 = G__2344;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args2339.length)].join('')));
...
if(cljs.core.truth_((function (){var and__218__auto__ = s;
if(cljs.core.truth_(and__218__auto__)){
return !((s === ""));
} else {
return and__218__auto__;
